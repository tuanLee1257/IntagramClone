...
import {TextInput, View, Image, StyleSheet, Text, Button} from 'react-native';
...
function FormikPostUploader({navigation}) {
  ...
  return (
    <Formik
      ...
      {({handleBlur, handleChange, handleSubmit, values, schema, errors}) => (
        <>
          <View style={{flexDirection: 'row'}}>
            <Image
              source={{uri: thumbnailURL ? thumbnailURL : ImagePlaceHolder}}
